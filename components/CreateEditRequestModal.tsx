...
const CreateEditRequestModal: React.FC<CreateEditRequestModalProps> = ({ order, onClose, onCreateLink }) => {
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full pl-4 pr-24 py-2 bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-md font-mono text-sm"
                        />
                         <button 
                            onClick={handleCopy}
